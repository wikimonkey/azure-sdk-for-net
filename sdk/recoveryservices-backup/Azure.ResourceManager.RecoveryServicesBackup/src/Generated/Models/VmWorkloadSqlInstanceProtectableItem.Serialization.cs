...
{
    public partial class VmWorkloadSqlInstanceProtectableItem : IUtf8JsonSerializable
    {
        ...
        internal static VmWorkloadSqlInstanceProtectableItem DeserializeVmWorkloadSqlInstanceProtectableItem(JsonElement element)
        {
            ...
            return new VmWorkloadSqlInstanceProtectableItem(backupManagementType.Value, workloadType.Value, protectableItemType, friendlyName.Value, Optional.ToNullable(protectionState), parentName.Value, parentUniqueName.Value, serverName.Value, Optional.ToNullable(isAutoProtectable), Optional.ToNullable(isAutoProtected), Optional.ToNullable(subinquireditemcount), Optional.ToNullable(subprotectableitemcount), prebackupvalidation.Value);
        }
    }
}
